...
<head>
    ...
    <title>Nouveau mot de passe — EcoPoche</title>
        ...
        <form method="POST" action="{{ route('password.update') }}" class="space-y-4">
            ...
            <div>
                ...
                <input type="password" name="password" required autofocus
                       class="w-full px-3.5 py-2.5 border @error('password') border-[#EF4444] @else border-[#E5E7EB] @enderror rounded-xl text-sm focus:outline-none focus:border-[#002452] focus:ring-2 focus:ring-[#002452]/10 transition-colors"
            ...
            <div>
                <label class="block text-xs font-semibold text-[#6B7280] mb-1.5 uppercase tracking-wide">Confirmer le mot de passe</label>
                <input type="password" name="password_confirmation" required
                       class="w-full px-3.5 py-2.5 border border-[#E5E7EB] rounded-xl text-sm focus:outline-none focus:border-[#002452] focus:ring-2 focus:ring-[#002452]/10 transition-colors"
